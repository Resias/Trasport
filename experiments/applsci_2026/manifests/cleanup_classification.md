...
| `review_runs/review_3way_50ep_20260512/` | 23G subset | Final checkpoint/result basis for paper reruns |
...
| `metro-GATrasformer-od-week-latlon/` | 90M | Standalone Metro-GATF runs; keep path stable, archive after review-run checkpoints are verified |
| `metro-GCN-LSTM/` | 1.2M | Standalone baseline runs; archive after review-run checkpoints are verified |
| `metro-MPGCN/` | 228K | Standalone baseline runs; archive after review-run checkpoints are verified |
...
| `archive/legacy_models/` | small | Archived ST-DAMHGN source kept for historical inspection |
